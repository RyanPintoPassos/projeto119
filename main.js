...
function draw() {
    ...
    stroke(0);
    //se o mouse for pressionado, desenhe uma linha entre as posições anterior a atual do mouse
    if (mouseIsPressed) {
...
function gotResult(error, results) {
    ...
    document.getElementById('confidance').innerHTML = 'Precisão: ' + Math.round(results[0].confidance * 100) + '%';
}
...
{
    timerConter++;
    document.getElementById('time').innerHTML = 'Tempo: ' + timerConter;
